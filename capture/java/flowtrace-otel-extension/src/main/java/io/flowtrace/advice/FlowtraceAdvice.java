...
public class FlowtraceAdvice {
    ...
    public static void onEnter(
        ...
        try {
            ...
            // but knows nothing about env vars — and Node and Python both
            // honour FLOWTRACE_TRACEPARENT, so without this a Node parent
            // spawning a Java child would split into two unrelated traces.
