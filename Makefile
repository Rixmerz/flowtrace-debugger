...
test: validate-schema golden-verify truncation-parity test-java test-python test-node
	...
	@cd flowtrace-cli && for t in test/test-cli.js test/test-cli-java.js test/test-cli-python.js test/test-cli-node.js test/test-detect.js test/test-cli-autodetect.js test/test-analyze.js test/test-run-passthrough.js test/test-gitignore.js test/test-analyze-dashboard.js; do node $$t || exit 1; done
